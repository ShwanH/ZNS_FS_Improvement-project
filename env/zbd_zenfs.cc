...
*/
//IO zone is full, then it call this. Move to S_ZBD
/*
...
*/
//Write in io zone ends and zone closes successfully, then call this.Move to S_ZBD
/*
...
*/
//GC thread ends, then call this. Move to S_ZBD 
/*
...
*/
//when zone allocatoin starts, call this. Move to S_ZBD
/*
